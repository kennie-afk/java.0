package com.smartseason.automation.ratelimit;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE = "automation-service";
...
"code":"rate-limited"}""".formatted(seconds));
    ...
    private static String tenant() {
        return com.smartseason.automation.platform.TenantContext.tenantId()
