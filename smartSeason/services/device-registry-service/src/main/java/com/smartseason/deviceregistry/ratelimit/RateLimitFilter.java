package com.smartseason.deviceregistry.ratelimit;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE = "device-registry-service";
...
"code":"rate-limited"}""".formatted(seconds));
    ...
    private static String tenant() {
        return com.smartseason.deviceregistry.platform.TenantContext.tenantId()
