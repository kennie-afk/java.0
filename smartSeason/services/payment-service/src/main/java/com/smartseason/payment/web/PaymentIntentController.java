...
import com.smartseason.payment.service.PaymentIntentService;
...
@RestController
@RequestMapping("/api/payment/v1/payment-intents")
@Tag(name = "PaymentIntent", description = "Payment intents, M-Pesa STK/C2B/B2C, cards, wallets, escrow, callback reconciliation")
public class PaymentIntentController {
    ...
    public ResponseEntity<PaymentIntentResponse> create(@Valid @RequestBody PaymentIntentCreateRequest request) {
        ...
        return ResponseEntity.created(URI.create("/api/payment/v1/payment-intents/" + created.id())).body(created);
    }
