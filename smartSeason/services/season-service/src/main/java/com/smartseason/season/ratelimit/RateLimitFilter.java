package com.smartseason.season.ratelimit;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE = "season-service";
...
"code":"rate-limited"}""".formatted(seconds));
    ...
    private static String tenant() {
        return com.smartseason.season.platform.TenantContext.tenantId()
