package com.smartseason.logistics.ratelimit;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE = "logistics-service";
...
"code":"rate-limited"}""".formatted(seconds));
    ...
    private static String tenant() {
        return com.smartseason.logistics.platform.TenantContext.tenantId()
