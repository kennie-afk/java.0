package com.smartseason.weather.ratelimit;
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private static final String SERVICE = "weather-service";
...
"code":"rate-limited"}""".formatted(seconds));
    ...
    private static String tenant() {
        return com.smartseason.weather.platform.TenantContext.tenantId()
