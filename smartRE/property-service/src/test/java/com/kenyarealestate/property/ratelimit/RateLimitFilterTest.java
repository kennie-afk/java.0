package com.kenyarealestate.property.ratelimit;
...
class RateLimitFilterTest {
    ...
    class Scope {
        ...
        void internalExempt() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/properties/internal/sync");
            req.setRequestURI("/api/properties/internal/sync");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
    ...
    class Buckets {
        ...
        void readAndWriteKeysDiffer() throws Exception {
            MockHttpServletRequest read = new MockHttpServletRequest("GET", "/api/properties");
            read.setRequestURI("/api/properties");
            read.setRemoteAddr("10.0.0.1");
            MockHttpServletRequest write = new MockHttpServletRequest("DELETE", "/api/properties/1");
            write.setRequestURI("/api/properties/1");
