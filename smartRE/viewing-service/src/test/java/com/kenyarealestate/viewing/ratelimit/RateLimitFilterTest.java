...
class RateLimitFilterTest {
    ...
    class Scope {
        ...
        void internalExempt() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/viewings/internal/sync");
            req.setRequestURI("/api/viewings/internal/sync");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
        ...
        void disabled() throws Exception {
            ...
            MockHttpServletRequest req = new MockHttpServletRequest("GET", "/api/viewings");
            req.setRequestURI("/api/viewings");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
    }
    ...
    class Buckets {
        ...
        void writeUsesWriteLimits() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/viewings");
            req.setRequestURI("/api/viewings");
            req.setRemoteAddr("10.0.0.1");
            filter.doFilter(req, response, chain);
        ...
        void readAndWriteKeysDiffer() throws Exception {
            MockHttpServletRequest read = new MockHttpServletRequest("GET", "/api/viewings");
            read.setRequestURI("/api/viewings");
            read.setRemoteAddr("10.0.0.1");
            MockHttpServletRequest write = new MockHttpServletRequest("DELETE", "/api/viewings/1");
            write.setRequestURI("/api/viewings/1");
