...
class RateLimitFilterTest {
    ...
    class Scope {
        ...
        void internalExempt() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/verifications/internal/sync");
            req.setRequestURI("/api/verifications/internal/sync");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
        ...
        void disabled() throws Exception {
            ...
            MockHttpServletRequest req = new MockHttpServletRequest("GET", "/api/verifications");
            req.setRequestURI("/api/verifications");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
    }
    ...
    class Buckets {
        ...
        void writeUsesWriteLimits() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/verifications");
            req.setRequestURI("/api/verifications");
            req.setRemoteAddr("10.0.0.1");
            filter.doFilter(req, response, chain);
        ...
        void readAndWriteKeysDiffer() throws Exception {
            MockHttpServletRequest read = new MockHttpServletRequest("GET", "/api/verifications");
            read.setRequestURI("/api/verifications");
            read.setRemoteAddr("10.0.0.1");
            MockHttpServletRequest write = new MockHttpServletRequest("DELETE", "/api/verifications/1");
            write.setRequestURI("/api/verifications/1");
