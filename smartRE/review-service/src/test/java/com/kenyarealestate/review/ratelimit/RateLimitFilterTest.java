...
class RateLimitFilterTest {
    ...
    class Scope {
        ...
        void internalExempt() throws Exception {
            MockHttpServletRequest req = new MockHttpServletRequest("POST", "/api/reviews/internal/sync");
            req.setRequestURI("/api/reviews/internal/sync");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
        ...
        void disabled() throws Exception {
            ...
            MockHttpServletRequest req = new MockHttpServletRequest("GET", "/api/reviews");
            req.setRequestURI("/api/reviews");
            filter.doFilter(req, response, chain);
            verifyNoInteractions(limiter);
        }
    }
    ...
    class Buckets {
        ...
        void readAndWriteKeysDiffer() throws Exception {
            MockHttpServletRequest read = new MockHttpServletRequest("GET", "/api/reviews");
            read.setRequestURI("/api/reviews");
            read.setRemoteAddr("10.0.0.1");
            MockHttpServletRequest write = new MockHttpServletRequest("DELETE", "/api/reviews/1");
            write.setRequestURI("/api/reviews/1");
